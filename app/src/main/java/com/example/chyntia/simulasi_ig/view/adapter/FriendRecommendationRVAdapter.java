...
public class FriendRecommendationRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FriendRecommendationRVAdapter(List<Data_Follow> user, Context context) {
        this.user = user;
    ...
    public void follow_states(View v, FriendRecommendationRVAdapter.ViewHolder _holder){
        if (v.getId() == R.id.btn) {
